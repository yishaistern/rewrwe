...
import { GameState, Question } from 'src/app/interfaces/model-interface';
import { correctAnswer, resetGame, rongAnswer, setQuestion, setTimeLeft, winGame } from 'src/app/store/actions';
import { selectGame, selectTime } from 'src/app/store/game-reducer';
