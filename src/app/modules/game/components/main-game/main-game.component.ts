...
import { GameState } from 'src/app/interfaces/model-interface';
import { selectGame } from 'src/app/store/game-reducer';
import { GameService } from '../../../shared/services/game/game.service';
import { GameOverComponent } from '../game-over/game-over.component';
import { cleerGame, userScore } from '../../../../store/actions';
import { selectCurrentuser } from 'src/app/store/main-reducer';
